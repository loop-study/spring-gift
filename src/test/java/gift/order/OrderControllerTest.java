...
class OrderControllerTest extends IntegrationTest {
    ...
    void 주문을_생성한다() throws Exception {
        ...
        String token = loginAndGetToken("user1@example.com", "password1");
        OrderRequest request = createRequest(1L, 1, "테스트 주문 메시지");
    ...
    void 존재하지_않는_옵션으로_주문하면_404를_반환한다() throws Exception {
        // given
        String token = loginAndGetToken("user1@example.com", "password1");
        OrderRequest request = createRequest(999999L, 1, null);
    ...
    void 재고_초과_주문시_400을_반환한다() throws Exception {
        ...
        String token = loginAndGetToken("user1@example.com", "password1");
        OrderRequest request = createRequest(1L, 11, "재고 초과 테스트");
    ...
    void 주문_생성_시_해당_상품의_위시가_삭제된다() throws Exception {
        ...
        String token = loginAndGetToken("user1@example.com", "password1");
        OrderRequest request = createRequest(1L, 1, "위시 클린업 테스트");
